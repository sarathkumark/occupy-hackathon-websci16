(function(angular) {
  ...
  angular.module('electron-app', ['ngMaterial', 'ngSanitize', 'ui.router', 'ngAnimate', 'angular-centered', 'leaflet-directive'])
  ...
  angular.module('electron-app').controller('ShellController', ['$scope', '$log', '$q', 'modules', ShellController]);
